...
for(let i=0;i<playlistTracksData.length;i++){
    playlistTracks.push(
        <Track key = {playlistTracksData[i].songId} accessKey = {playlistTracksData[i].accessKey} song = {playlistTracksData[i].song} artist = {playlistTracksData[i].artist} album = {playlistTracksData[i].album} albumCover = {playlistTracksData[i].albumCover} isAdd = {playlistTracksData[i].isAdd} removeSong = {playlistTracksData[i].removeSong} />
    )
